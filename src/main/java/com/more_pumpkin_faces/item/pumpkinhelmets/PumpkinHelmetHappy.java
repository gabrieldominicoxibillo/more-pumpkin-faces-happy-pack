//#2 the item (wearable pumpkin helmet)
...
public class PumpkinHelmetHappy extends BlockItem implements Equipment {
    ...
    public PumpkinHelmetHappy(Block block, Settings settings) {
